...
export default function Home() {
  ...
  return (
    <div className="">
      ...
      <OrderingInfo />
      <BottomPart />
      <div className="text-center">We're all gonna make it © 2024 | Développé  Par <Link className="underline" href="https://efflorescence.vercel.app/" target="blank">Efflorescence</Link> </div>
    </div>
  );
}
...
function HeadLine() {
  ...
  return <div className="flex min-w-full flex-col items-center justify-center">
    ...
    <div className="mt-8 mx-auto mb-4 flex max-w-fit items-center justify-center text-center">      <i >
      We're all gonna make it Ltd est une entreprise de restauration dédiée à offrir des expériences culinaires inoubliables
    </i>
    </div>
...
function BottomPart() {
  return <div className='mx-auto mb-32 mt-32 max-w-5xl sm:mt-56 bg-secondary rounded-lg p-2 py-4'>
    <div className="mt-4 mx-auto mb-4 max-w-fit items-center justify-center text-center">
      <h2 className='mt-8 font-bold text-4xl sm:text-5xl'>
        Nous Sommes We're all gonna make it
      </h2>
    </div>
    <div className="mt-4 mx-auto mb-4 max-w-fit items-center justify-center text-center">
      <p>
        We're all gonna make it Ltd est une entreprise de restauration dédiée à offrir des expériences culinaires inoubliables. Basée à votre localisation, notre équipe passionnée et professionnelle met un point d'honneur à satisfaire vos papilles avec des plats exquis et un service irréprochable.
      </p>
